...
def add_documents_to_db(pdfs_bytes):
    ...
    # Explicitly extract page content and use add_texts
    texts_to_embed = [doc.page_content for doc in documents]
    metadatas = [doc.metadata for doc in documents]  # Keep metadata if you have it
    vector_db.add_texts(texts_to_embed, metadatas=metadatas)
